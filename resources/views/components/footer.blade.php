                ...
                <div class="col-md-3 col-sm-4">
                    <div class="single-snap-footer">
                        ...
                        <div class="cakewalk-footer-content">
                            <p class="footer-des">Công ty Cổ phần Bán lẻ Kỹ thuật số FPT (gọi tắt là FPT Retail) là một thành viên của Tập đoàn FPT Việt Nam, được thành lập vào ngày 8/3/2012 với hai thương hiệu chính là FPT Shop và F.Studio By FPT – Đại lý được ủy quyền chính thức của Apple tại Việt Nam ở cấp độ cao cấp nhất.</p>
            ...
            <div class="row">
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Địa chỉ</h3>
                            <p>Hạ Nông Tây - Điện Phước - Điện Bàn - Quảng nam</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 col-sm-4">
                ...
                <div class="col-md-3 col-sm-4">
                    <div class="info-fcontainer">
                        ...
                        <div class="infof-content">
                            <h3>Email hỗ trợ</h3>
                            <p>cuongnguyen.210998@gmail.com</p>
                        </div>
                    </div>
                </div>
